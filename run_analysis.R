...
source(file.path(CFG$root, "01_EDA.R"))
source(file.path(CFG$root, "02_decomposition_smoothing.R"))
source(file.path(CFG$root, "03_arima.R"))
source(file.path(CFG$root, "04_comparison_oos.R"))
